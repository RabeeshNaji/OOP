...
public class Control {
    ...
    public boolean addflight(String from, String to, String dep_date, String arv_date, int numtravelers, int travelersprice, String s)
    {
    ...
    public void readTravelersFiles() throws FileNotFoundException {
        Scanner in=new Scanner(new File("C:\\Users\\DELL\\Documents\\java\\Travelers.txt"));
        while (in.hasNext())
        {
            int i=in.nextInt();
            String f=in.next();
    ...
    public void writeTravelers() throws FileNotFoundException {
        PrintWriter writer=new PrintWriter("C:\\Users\\DELL\\Documents\\java\\Travelers.txt");
        int i=0;
    ...
    public void readFlightsFiles() throws FileNotFoundException {
        Scanner in=new Scanner(new File("C:\\Users\\DELL\\Documents\\java\\Flighta.txt"));
        while (in.hasNext())
        {
          String f=in.next();
            String t=in.next();
            ...
            int n=in.nextInt();
            int p=in.nextInt();
            addflight(f,t,a,d,n,p,d);
        }
        in.close();
    }
    public void writeFlightsFile() throws FileNotFoundException {
        PrintWriter writer=new PrintWriter("C:\\Users\\DELL\\Documents\\java\\Flighta.txt");
        int i=0;
        while (i<numflight)
        {
